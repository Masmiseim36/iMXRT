 ...
 ******************************************************************************/
	  ...
	  defined(CPU_MIMXRT1152DHM8B) || defined(CPU_MIMXRT1152DVM8B) || defined(CPU_MIMXRT1152XHM8B) || defined(CPU_MIMXRT1152XVM8B))
	#define BOARD_BOOTCLOCKRUN_CORE_CLOCK 798000000UL /*!< CM7 Core clock frequency: 798000000Hz */
#elif (defined(CPU_MIMXRT1152AHM6B) || defined(CPU_MIMXRT1152AVM6B))
...
#define BOARD_BOOTCLOCKRUN_ARM_PLL_CLK                BOARD_BOOTCLOCKRUN_CORE_CLOCK /* Clock consumers of ARM_PLL_CLK output : N/A */
#define BOARD_BOOTCLOCKRUN_ASRC_CLK_ROOT              24000000UL     /* Clock consumers of ASRC_CLK_ROOT output : ASRC */
#define BOARD_BOOTCLOCKRUN_AXI_CLK_ROOT               BOARD_BOOTCLOCKRUN_CORE_CLOCK /* Clock consumers of AXI_CLK_ROOT output : FLEXRAM */
...
#define BOARD_BOOTCLOCKRUN_M7_CLK_ROOT                BOARD_BOOTCLOCKRUN_CORE_CLOCK /* Clock consumers of M7_CLK_ROOT output : ARM */
