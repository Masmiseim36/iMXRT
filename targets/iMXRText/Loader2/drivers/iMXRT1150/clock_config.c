...
- {id: ARM_PLL_CLK.outFreq, value: 600/798 MHz}
- {id: ASRC_CLK_ROOT.outFreq, value: 24 MHz}
- {id: AXI_CLK_ROOT.outFreq, value: 600/798 MHz}
...
- {id: M7_CLK_ROOT.outFreq, value: 600/798 MHz}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set DCDC to CCM mode to improve stability. */
