 ...
 ******************************************************************************/
	...
	#define BOARD_BOOTCLOCKRUN_CORE_CLOCK             600000000UL  /*!< Core clock frequency: 600000000Hz */
#elif (defined(CPU_MIMXRT1041XFP5B) || defined(CPU_MIMXRT1041XJM5B) || defined(CPU_MIMXRT1042XFP5B) || defined(CPU_MIMXRT1042XJM5B))
	#define BOARD_BOOTCLOCKRUN_CORE_CLOCK             528000000UL  /*!< Core clock frequency: 528000000Hz */
#else
	#error "Unknown CPU"
#endif
...
#define BOARD_BOOTCLOCKRUN_GPT1_IPG_CLK_HIGHFREQ      BOARD_BOOTCLOCKRUN_CORE_CLOCK / 8
#define BOARD_BOOTCLOCKRUN_GPT2_IPG_CLK_HIGHFREQ      BOARD_BOOTCLOCKRUN_CORE_CLOCK / 8
#define BOARD_BOOTCLOCKRUN_IPG_CLK_ROOT               BOARD_BOOTCLOCKRUN_CORE_CLOCK / 4
...
#define BOARD_BOOTCLOCKRUN_PERCLK_CLK_ROOT            BOARD_BOOTCLOCKRUN_CORE_CLOCK / 8
...
#define BOARD_BOOTCLOCKRUN_SEMC_CLK_ROOT              BOARD_BOOTCLOCKRUN_CORE_CLOCK / 8
