...
{
	#if (defined(CPU_MIMXRT1051DVJ6B) || defined(CPU_MIMXRT1051DVL6B) || defined(CPU_MIMXRT1052DVJ6B) || defined(CPU_MIMXRT1052DVL6B))
		.loopDivider = 100,                    /* PLL loop divider, Fout = Fin * 50  --> 600 MHz */
	#elif (defined(CPU_MIMXRT1051CVJ5B) || defined(CPU_MIMXRT1051CVL5B) || defined(CPU_MIMXRT1052CVJ5B) || defined(CPU_MIMXRT1052CVL5B))
		.loopDivider = 88,                    /* PLL loop divider, Fout = Fin * 44  --> 528 MHz */
	#else
		#error "Unknown iMXRT1050 device"
	#endif
