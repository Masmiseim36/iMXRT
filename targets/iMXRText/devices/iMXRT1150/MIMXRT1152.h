 ...
 * @version 0.2
 * @date 2026-02-26
 * @brief CMSIS Peripheral Access Layer for MIMXRT1152
 *
 * CMSIS Peripheral Access Layer for MIMXRT1152
 */

#if !defined(MIMXRT1152_H_)  /* Check if memory map has not been already included */
#define MIMXRT1152_H_
...
#include "./periph/PERI_ENET_QOS.h"
...
#endif  /* #if !defined(MIMXRT1152_H_) */
