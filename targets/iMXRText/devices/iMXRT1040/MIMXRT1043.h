 ...
 * @version 1.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMXRT1043
 *
 * CMSIS Peripheral Access Layer for MIMXRT1043
 */

#if !defined(MIMXRT1043_H_)  /* Check if memory map has not been already included */
#define MIMXRT1043_H_
...
#endif  /* #if !defined(MIMXRT1043_H_) */
