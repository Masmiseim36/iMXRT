...
/*!
 * @file MIMXRT1175_cm7.h
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMXRT1175_cm7
 *
 * CMSIS Peripheral Access Layer for MIMXRT1175_cm7
 */

#if !defined(MIMXRT1175_cm7_H_)  /* Check if memory map has not been already included */
#define MIMXRT1175_cm7_H_
...
#endif  /* #if !defined(MIMXRT1175_cm7_H_) */
