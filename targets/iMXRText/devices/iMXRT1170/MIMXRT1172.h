 ...
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMXRT1172
 *
 * CMSIS Peripheral Access Layer for MIMXRT1172
 */

#if !defined(MIMXRT1172_H_)  /* Check if memory map has not been already included */
#define MIMXRT1172_H_
...
#endif  /* #if !defined(MIMXRT1172_H_) */
