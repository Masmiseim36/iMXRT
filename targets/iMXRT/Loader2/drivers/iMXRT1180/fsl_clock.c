...
{
    return ((OSC_RC_400M->STAT0 & OSC_RC_400M_STAT0_CLK1M_ERR_MASK) == OSC_RC_400M_STAT0_CLK1M_ERR_MASK);
}
...
{
    return (uint16_t)((OSC_RC_400M->STAT1 & OSC_RC_400M_STAT1_CURR_COUNT_VAL_MASK) >>
...
{
    return (uint8_t)((OSC_RC_400M->STAT2 & OSC_RC_400M_STAT2_CURR_OSC_TUNE_VAL_MASK) >>
...
bool CLOCK_EnableUsbhs0PhyPllClock(clock_usb_phy_src_t src, uint32_t freq)
{
    ...
    USBPHY1->PLL_SIC_SET = USBPHY_PLL_SIC_PLL_REG_ENABLE_MASK;
    SDK_DelayAtLeastUs(15U, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    USBPHY1->PLL_SIC_SET = USBPHY_PLL_SIC_PLL_POWER(1);
...
bool CLOCK_EnableUsbhs1PhyPllClock(clock_usb_phy_src_t src, uint32_t freq)
{
    ...
    USBPHY2->PLL_SIC_SET = USBPHY_PLL_SIC_PLL_REG_ENABLE_MASK;
    SDK_DelayAtLeastUs(15U, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    USBPHY2->PLL_SIC_SET = USBPHY_PLL_SIC_PLL_POWER(1);
