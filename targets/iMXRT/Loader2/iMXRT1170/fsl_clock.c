 ...
 *
 * param src Used to select the source for 16MHz RC oscillator, please refer to clock_16MOsc_source_t.
 ...
 */
void CLOCK_OSC_SetOsc16MConfig(clock_16MOsc_source_t src, bool enablePowerSave, bool enableClockOut)
{
    uint32_t tmp32;
    ...
    tmp32 |= ANADIG_OSC_OSC_16M_CTRL_EN_IRC4M16M(enableClockOut) |
             ANADIG_OSC_OSC_16M_CTRL_EN_POWER_SAVE(enablePowerSave) | ANADIG_OSC_OSC_16M_CTRL_SOURCE_SEL_16M(src);
