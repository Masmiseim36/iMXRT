...
typedef struct {
  ...
  __IO uint32_t SELECT_INPUT[IOMUXC_SELECT_INPUT_COUNT]; /**< FLEXCAN1_RX_SELECT_INPUT DAISY Register..XBAR1_IN_SELECT_INPUT_35 DAISY Register, array offset: 0x498, array step: 0x4, valid indices: [0-1, 4-20, 26-122, 129-159] */
} IOMUXC_Type;
