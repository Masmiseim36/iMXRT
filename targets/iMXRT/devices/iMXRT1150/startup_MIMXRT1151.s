...
ISR_RESERVED                                      // Reserved45_IRQHandler              - Reserved interrupt
ISR_RESERVED                                      // Reserved46_IRQHandler              - Reserved interrupt
...
ISR_RESERVED                                      // Reserved52_IRQHandler              - Reserved interrupt
...
ISR_RESERVED                                      // Reserved59_IRQHandler              - Reserved interrupt
...
ISR_RESERVED                                      // Reserved64_IRQHandler              - Reserved interrupt
ISR_RESERVED                                      // Reserved65_IRQHandler              - Reserved interrupt
ISR_HANDLER2 FLEXRAM                              // FLEXRAM_IRQHandler                 - FlexRAM address out of range Or access hit IRQ
ISR_HANDLER2 KPP                                  // KPP_IRQHandler                     - Keypad interrupt
ISR_RESERVED                                      // Reserved68_IRQHandler              - Reserved interrupt
ISR_HANDLER2 GPR_IRQ                              // GPR_IRQ_IRQHandler                 - GPR interrupt
ISR_RESERVED                                      // Reserved70_IRQHandler              - eLCDIF interrupt
ISR_HANDLER2 LCDIFv2                              // LCDIFv2_IRQHandler                 - LCDIFv2 interrupt
ISR_RESERVED                                      // Reserved72_IRQHandler              - CSI interrupt
ISR_RESERVED                                      // Reserved73_IRQHandler              - PXP interrupt
...
ISR_RESERVED                                      // Reserved96_IRQHandler              - Reserved interrupt
ISR_RESERVED                                      // Reserved97_IRQHandler              - Reserved interrupt
...
ISR_RESERVED                                      // Reserved108_IRQHandler             - Reserved interrupt
...
ISR_RESERVED                                      // Reserved134_IRQHandler             - Reserved interrupt
...
ISR_RESERVED                                      // Reserved153_IRQHandler             - Reserved interrupt
ISR_RESERVED                                      // Reserved154_IRQHandler             - Reserved interrupt
...
ISR_HANDLER2 XBAR1_IRQ_0_1                        // XBAR1_IRQ_0_1_IRQHandler           - XBARA1 output signal 0, 1 interrupt
ISR_HANDLER2 XBAR1_IRQ_2_3                        // XBAR1_IRQ_2_3_IRQHandler           - XBARA1 output signal 2, 3 interrupt
...
ISR_RESERVED                                      // Reserved220_IRQHandler             - Reserved interrupt
ISR_RESERVED                                      // Reserved221_IRQHandler             - Reserved interrupt
